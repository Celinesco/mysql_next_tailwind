        ...
        <div key={post.id} className='border border-gray-200 shadow my-6 p-10 flex justify-between bg-white'>
          ...
          <div className='flex'>
            <Link href={`/posts/${post.id}`}>
              <button type="button" className="text-purple-500  hover:bg-gray-100 focus:ring-1 focus:outline-none w-9 h-9 rounded-full p-2 flex items-center hover:shadow justify-center">
            ...
            <button type="button" className="text-yellow-400  hover:bg-gray-100 focus:ring-1  w-9 h-9 rounded-full p-2 flex items-center hover:shadow justify-center" >
              <PencilIcon />
            </button>
            </Link>
